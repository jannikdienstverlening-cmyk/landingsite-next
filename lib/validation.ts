...
export const intakeFormSchema = z.object({
  ...
  primaire_actie: z.string().trim().min(3).max(220),
  ...
  concurrenten: optionalText,
  gewenste_paginas: optionalText,
  bestaand_domein: optionalShort,
  teksten_status: optionalText,
  technische_koppelingen: optionalText,
