    ...
    <main className="legal-page">
      <div className="container legal-shell">
        ...
        <div className="legal-content">
          <section><h2>1. Verantwoordelijke</h2><p>{BUSINESS.legalName}, handelend onder {BUSINESS.brandName}, is verwerkingsverantwoordelijke voor persoonsgegevens die we voor verkoop, administratie en onze eigen dienstverlening verwerken. Adres: {BUSINESS_ADDRESS}, {BUSINESS.address.country}. KvK: {BUSINESS.chamberOfCommerceNumber}. Btw-id: {BUSINESS.vatId}. Vragen of verzoeken kunnen naar <a href={`mailto:${BUSINESS.email}`}>{BUSINESS.email}</a>.</p></section>
          <section><h2>2. Welke gegevens we verwerken</h2><p>We kunnen naam, bedrijfsnaam, KvK- en btw-nummer, e-mail, telefoon, factuur- en adresgegevens, pakketkeuze, Stripe-klant-, checkout-, abonnement- en factuurreferenties, intake-antwoorden, uploads, correspondentie en technische beveiligingsgegevens verwerken. Betaalkaart- en bankgegevens worden rechtstreeks door Stripe verwerkt en komen niet op onze servers terecht.</p></section>
          ...
          <section><h2>4. Betalingen en abonnementen</h2><p>Stripe verwerkt de checkout, betaalmethode, automatische maandincasso, btw- en factuurgegevens en abonnementsstatus. Wij ontvangen alleen de gegevens en technische referenties die nodig zijn om betaling te herkennen, de opdracht te starten, verlengingen te administreren en mislukte betalingen of opzeggingen af te handelen. Stripe handelt voor een deel als zelfstandige verwerkingsverantwoordelijke; het eigen privacybeleid van Stripe geldt daar ook.</p></section>
          ...
          <section><h2>10. Cookies en tracking</h2><p>De publieke website gebruikt momenteel geen advertentiecookies of externe analysetrackers. Het afgeschermde dashboard gebruikt na inloggen een strikt noodzakelijke beveiligde sessiecookie. Stripe kan tijdens checkout en facturatie noodzakelijke fraudepreventie- en betaalcookies gebruiken.</p></section>
