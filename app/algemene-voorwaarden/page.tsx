    ...
    <main className="legal-page">
      <div className="container legal-shell">
        ...
        <div className="legal-content">
          ...
          <section><h2>2. Aanbod en overeenkomst</h2><p>De pakketpagina beschrijft de actuele scope, maandprijs en inbegrepen dienstverlening. Een overeenkomst komt tot stand wanneer de zakelijke klant schriftelijk akkoord geeft op het gekozen pakket of een afzonderlijke offerte. Kennelijke fouten in prijzen of omschrijvingen binden ons niet.</p></section>
          ...
          <section><h2>6. Pakketten en wijzigingen</h2><p>Starter, Groei en Premium verschillen in mate van begeleiding, optimalisatie en uitbreiding. Kleine wijzigingen vallen binnen de afgesproken ondersteuning. Nieuwe pagina’s, nieuwe functionaliteit, volledig nieuw ontwerp of extra campagnes kunnen apart worden aangeboden.</p></section>
          <section><h2>7. Betaling en btw</h2><p>Vermelde pakketprijzen zijn maandbedragen exclusief btw, tenzij anders aangegeven. Bij niet-betaling, terugboeking of mislukte incasso mogen we werkzaamheden, support of publicatie opschorten totdat betaling is hersteld.</p></section>
          <section><h2>8. Hosting, onderhoud en domein</h2><p>Hosting, SSL, updates, backups, onderhoud en support zijn inbegrepen volgens het gekozen pakket. De klant blijft eigenaar van de eigen domeinnaam en houdt toegang tot de domeinprovider. We helpen met de juiste domeinkoppeling, maar zijn niet verantwoordelijk voor vertraging of fouten bij registrars, DNS-providers of door de klant beheerde instellingen.</p></section>
          ...
          <section><h2>11. Resultaten en aansprakelijkheid</h2><p>We garanderen geen specifieke omzet, positie in zoekmachines, advertentieresultaten, leads of conversieratio. Voor zover wettelijk toegestaan is onze totale aansprakelijkheid beperkt tot het bedrag dat voor de betreffende maand of opdracht is betaald. We zijn niet aansprakelijk voor indirecte schade, gemiste winst, gevolgschade of schade door onjuiste input, behalve bij opzet of bewuste roekeloosheid.</p></section>
          <section><h2>12. Opzegging en overdracht</h2><p>Een maandpakket kan volgens de afgesproken termijn worden opgezegd. Bij opzegging eindigen onderhoud, support en managed publicatie aan het einde van de betaalde periode, tenzij overdracht of voortzetting apart is afgesproken. De klant blijft verantwoordelijk voor tijdige migratie of archivering.</p></section>
