...
export const metadata: Metadata = {
  ...
  description: 'Professionele landingspagina vanaf €299. Websitebeheer, hosting, beveiliging en kleine wijzigingen voor €79 per maand.',
  ...
  openGraph: {
    ...
    description: 'Professionele landingspagina vanaf €299 en Websitebeheer voor €79 per maand vanaf livegang.',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Landingspagina laten maken vanaf €299',
    description: 'Met Websitebeheer, beveiliging en kleine wijzigingen voor €79 per maand vanaf livegang.',
  },
